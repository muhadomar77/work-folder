...
Call log:
  - waiting for locator('//button[@class=\'search_btn train_Search\']')
    - locator resolved to <button type="submit" _ngcontent-fbf-c78="" class="search_btn train_Search"> Search Trains </button>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <td class="ng-tns-c69-9 ng-star-inserted">…</td> from <div _ngcontent-fbf-c78="" class="form-swap col-xs-12 remove-padding">…</div> subtree intercepts pointer events
    ...
    - generic [ref=e308]:
      ...
      - generic [ref=e416]:
        ...
        - generic [ref=e421]:
          ...
          - paragraph [ref=e429]: DM6MS6
  - generic [ref=e433] [cursor=pointer]: Easy Booking on AskDisha
  - complementary "AskDisha Chat Assistant" [ref=e435]:
    - generic [ref=e436] [cursor=pointer]:
      - img "Open Disha chat" [ref=e437]
      - img "Minimize chat" [ref=e438]
```
